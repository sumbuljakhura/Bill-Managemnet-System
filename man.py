...
class Bill_App:
    def __init__(self, kh):
        ...
        lbl_color = 'white'
        # Title of App
        title = Label(self.kh, text="Apna Software", bd=12, relief=GROOVE, fg=fg_color, bg=bg_color,
                      font=("times new roman", 45, "bold","italic","underline"), pady=3).pack(fill=X)
        ...
        # ==================Cosmetics Frame=====================#
        F2 = LabelFrame(self.kh, text='Cosmetics', bd=10, relief=GROOVE, bg=bg_color, fg="gold",
        ...
        # ==================Grocery Frame=====================#
        F2 = LabelFrame(self.kh, text='Grocery', bd=10, relief=GROOVE, bg=bg_color, fg="gold",
                        font=("times new roman", 13, "bold"))
        ...
        F2 = LabelFrame(self.kh, text='Others', bd=10, relief=GROOVE, bg=bg_color, fg="gold",
                        font=("times new roman", 13, "bold"))
        ...
        # =======
        fkhi_lbl = Label(F2, font=("times new roman", 15, "bold"), fg=lbl_color, bg=bg_color, text="Fkhi")
        fkhi_lbl.grid(row=2, column=0, padx=10, pady=20)
        fkhi_en = Entry(F2, bd=8, relief=GROOVE, textvariable=self.fkhi)
        fkhi_en.grid(row=2, column=1, ipady=5, ipadx=5)
        ...
        # ===========Buttons Frame=============#
        F4 = LabelFrame(self.kh, text='Bill Menu', bd=10, relief=GROOVE, bg=bg_color, fg="gold",
                        font=("times new roman", 13, "bold"))
    ...
    def welcome_soft(self):
        ...
        self.txt.insert(END, "       Welcome To Apna  Store\n")
    ...
    def bill_area(self):
        ...
        if self.fkhi.get() != 0:
            self.txt.insert(END, f"\nFkhi            {self.fkhi.get()}           {self.fkhi.get() * 50}")
        if self.coke.get() != 0:
